...
const Kontakt = () => {
  return (
    <Layout 
      title="Kontakt - Formularz i Dane Kontaktowe" 
      description="Skontaktuj się z zespołem Wirtualnego Alkomatu. Formularz kontaktowy oraz dane adresowe dla pytań dotyczących kalkulatora."
    >
